...
export default function ProductManager() {
  ...
  const handleEdit = (product) => {
    setForm({
      ...
      key_highlights: parseList(product.key_highlights),
      crop_benefits: parseList(product.crop_benefits),
      product_advantages: parseList(product.product_advantages),
      recommended_crops: parseList(product.recommended_crops),
