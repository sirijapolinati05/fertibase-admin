...
export default function AdminLayout() {
  ...
  const handleChangePassword = async (e) => {
    ...
    try {
      ...
      const empId = user?.empId || "NAVEENSIR"; // Fallback if context is lost
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                ...
                <button onClick={() => setChangePasswordOpen(false)} className="text-gray-400 hover:text-red-500 transition-colors">
                  <X size={20} />
                </button>
              </div>
              ...
              <form onSubmit={handleChangePassword} className="p-6 space-y-4">
                ...
                <div className="pt-4 flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all disabled:opacity-50"
                  >
